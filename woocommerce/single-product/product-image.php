...
<div class="<?php echo esc_attr(implode(' ', array_map('sanitize_html_class', $wrapper_classes))); ?>" data-columns="<?php echo esc_attr($columns); ?>" style="opacity: 0; transition: opacity .25s ease-in-out;">
	...
	<?php if ($product->is_type('variable')) { ?>
		<div class="product-image-instant-quote-holder">
			...
			<div id="single-product-placeholder" class="product-price-holder woocommerce-variation single_variation">
				Fill in the details above
			</div>

			<!-- <div class="product-price-holder">
			<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>240.00</span> &ndash; <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>450.00</span> <div class="inc-gst">inc. GST</div>
		</div> -->
